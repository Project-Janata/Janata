...
export default function AdminSidebar({ activeTab, onTabChange }: AdminSidebarProps) {
  ...
  return (
    ...
    >
      <Text style={{ fontFamily: 'Inclusive Sans', fontSize: 15, color: c.accent, marginBottom: 20, paddingHorizontal: 8 }}>
        Admin
      </Text>
      ...
      {tabs.map(({ key, label, Icon }) => {
        ...
        return (
          ...
          >
            ...
            <Text style={{ fontFamily: 'Inclusive Sans', fontSize: 14, marginLeft: 10, color }}>{label}</Text>
          </Pressable>
        )
      })}
    </View>
